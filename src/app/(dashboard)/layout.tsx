    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 flex flex-col shadow-sm">
        <div className="p-6 border-b border-slate-200">
          ...
          <p className="text-xs text-slate-500 mt-1">Sprint Management System</p>
        </div>
        
        <div className="p-4 flex-1">
          <div className="mb-4 px-2 py-3 bg-indigo-50 rounded-lg border border-indigo-100">
          ...
          <nav className="space-y-1">
            {user.name === 'Nashwa' && (
              <Link href="/admin" className="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-slate-700 hover:bg-slate-100 hover:text-indigo-600 transition-colors">
                <LayoutDashboard className="w-5 h-5 mr-3 text-slate-400" />
                Admin Dashboard
              </Link>
            )}
            <Link href="/board" className="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-slate-700 hover:bg-slate-100 hover:text-indigo-600 transition-colors">
